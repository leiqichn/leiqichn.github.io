...
date: 2026-03-13 09:03:35
categories:
  - [综合, 工具]
tags: [GitHub, 开源, Trending, 日报]
keywords: GitHub Trending, 开源项目, 技术日报, 2026/03/13
---
...
## 3. [openrag](https://github.com/langflow-ai/openrag)
...
## 10. [LiteRT](https://github.com/google-ai-edge/LiteRT)

LiteRT, successor to TensorFlow Lite. is Google's On-device framework for high-performance ML & GenAI deployment on edge platforms, via efficient conversion, runtime, and optimization

⚡ **C++** | ⭐ **+13** 今日 | 🏆 1,669 总计

**仓库地址**：`google-ai-edge/LiteRT`

---

## 11. [agency-agents](https://github.com/msitarzewski/agency-agents)
...
## 12. [A2UI](https://github.com/google/A2UI)
...
## 13. [claude-plugins-official](https://github.com/anthropics/claude-plugins-official)
